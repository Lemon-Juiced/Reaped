...
public class ModItems {
    ...
    public static final Supplier<Item> INFERNAL_SCYTHE = ITEMS.register("infernal_scythe", () -> new InfernalScytheItem(new Item.Properties().attributes(InfernalScytheItem.createAttributes(ModTiers.INFERNAL_SCYTHE_TIER, 4, -2.7f)).fireResistant()));
    public static final Supplier<Item> SOUL_SCYTHE = ITEMS.register("soul_scythe", () -> new SoulScytheItem(new Item.Properties().attributes(SoulScytheItem.createAttributes(ModTiers.SOUL_SCYTHE_TIER, 4, -2.7f))));
